...
% Last Modified by GUIDE v2.5 17-Apr-2014 10:06:08
...
% --- Executes on button press in pushbuttonPSF.
function pushbuttonPSF_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonPSF (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
computePSF_GUI;
